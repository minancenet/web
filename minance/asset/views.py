...
def assets():
  ...
  assets = Asset.query.order_by(Asset.name.asc()).paginate(page, per_page=15)
...
def filterAssets():
  ...
  return render_template("asset/assets.html", assets=assets.paginate(page, per_page=15), active_page="assets", title="Assets", round=round)
